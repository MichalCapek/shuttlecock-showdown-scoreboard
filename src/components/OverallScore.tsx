  ...
  return (
    <div className="flex items-center justify-center space-x-12 py-6">
      <div className="text-center">
        <div className="text-xl text-white mb-2">{homeTeam}</div>
        <div className="text-6xl font-bold text-white">{homeScore}</div>
      </div>
      <div className="flex flex-col items-center">
        <div className="text-white text-lg font-semibold">Overall Score</div>
      </div>
      <div className="text-center">
        <div className="text-xl text-white mb-2">{awayTeam}</div>
