        ...
        <Card>
            <CardHeader className="pb-3">
                <div className="flex items-start justify-between gap-2">
                    ...
                    <Link to={`/admin/${courtId}`}>
                        <Button variant="ghost" size="sm" className="gap-1 text-brand-blue">
                            Ovládání
                ...
                {!data ? (
                    ...
                    <>
                        ...
                        <div className="flex gap-2">
                            <Button variant="outline" size="sm" onClick={onEditNames} className="gap-1.5">
...
function TeamStat({
    ...
    return (
        <div className={`rounded-lg border ${borderColor} ${bgColor} p-3`}>
            ...
            <p className="mt-1 text-2xl font-bold tabular-nums">{points}</p>
